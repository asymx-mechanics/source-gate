...
| `github-witness/` | What does GitHub record that I cannot rewrite, and what can the human verify without me? | **Open.** Push-side answers verified; the undo side was refused by the permission check and is left to the owner. |
