...
`CLAUDE.md` exactly as it stood at commit `07f5ee0`, before it was shortened. It is a record, not
an instruction, and it is not edited after being listed in `memory/RINGS.sha256`. Everything below
